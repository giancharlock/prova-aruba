...
public class KafkaProducerConfig implements BeanPostProcessor {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        if (bean instanceof ProducerFactory) {
            ...
            if (!interceptors.contains("com.experis.dbmanager.interceptor.CorrelationIdProducerInterceptor")) {
                interceptors.add("com.experis.dbmanager.interceptor.CorrelationIdProducerInterceptor");
            }
